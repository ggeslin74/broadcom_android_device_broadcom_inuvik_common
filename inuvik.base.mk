...
LOCAL_DEVICE_RCS                 += device/broadcom/common/rcs/init.ft.mmu.tee.nx.v2.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.nx.rc
else
...
LOCAL_DEVICE_RCS                 += device/broadcom/common/rcs/init.fs.metaenc.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.fs.rc
...
LOCAL_DEVICE_FSTAB               := device/broadcom/inuvik-common/fstab/fstab.avb.abu:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.bcm
LOCAL_DEVICE_FSTAB               += device/broadcom/inuvik-common/fstab/fstab.avb.abu:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.inuvik
LOCAL_DEVICE_FSTAB               += device/broadcom/inuvik-common/fstab/fstab.avb.abu:$(TARGET_COPY_OUT_VENDOR_RAMDISK)/first_stage_ramdisk/fstab.inuvik
